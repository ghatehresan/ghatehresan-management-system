...
function layout_head($pageTitle = '') {
    ...
    $nav = [
        ...
        'activity'  => ['گزارش فعالیت',    'M4 5h16M4 12h16M4 19h10'],
...
<aside class="side">
  ...
  <div class="side-ft">
    ...
    <?php $u = auth_user(); if ($u): ?>
      ...
      <div class="ver" style="margin-bottom:3px;color:#8aa0b8"><?= e(role_label($u['role'])) ?></div>
      <a href="<?= url('account') ?>" class="ver" style="display:block;margin-bottom:7px;color:#f3a36e;text-decoration:none">حساب من · تغییر رمز</a>
